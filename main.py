...
while True: #Vòng lặp vô hạn
    ...
    for face in faces:   #kiểm tra từng face trong list faces, chạy liên tục
        face_landmarks = dlib_facelandmark(gray, face)  #cho khuôn mặt nhận được dạng gray chạy qua model 68 điểm, móc nối lên dòng 33 là tiền xử lý ảnh
        leftEye = []
        rightEye = []
        ...
        if EYE<0.22:         #nếu độ mở của mắt nhỏ hơn 0.3 thì tính là một lần nháy
            ...
            if c > 40:           #nếu nháy mắt quá 3 lần trong 5 giây
            ...
            if c > 100:      #nếu nháy mắt quá 10 lần trong 5 giây thì 
...
#         print(abs(eyeL-eyeR))
        ...
        if abs(eyeL-eyeR) > 10:     #nếu nghiêng đầu thì
            ...
            if second1 - second2 > 6:       #quá 6 giây thì còi kêu
                ...
                print ("coi keu")
            if v>=10 and v<11 and music == 0:   #quá 2 giây thì phát nhạc
                music = 1
                #p.play()
                mixer.music.play()
                print ("phat song beta")
